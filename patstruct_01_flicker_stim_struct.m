...
stim(1).ypos_vec = [nan(1, prestim_time*50)...
                    ...
                    nan(1, poststim_time*50)];
stim(1).type = 'flicker';
stim(1).time = length(stim(1).xpos_vec)/50;
...
stim(2).ypos_vec = [nan(1, prestim_time*50)...
                    ...
                    nan(1, poststim_time*50)];
stim(2).type = 'flicker';
stim(2).time = length(stim(2).xpos_vec)/50;
...
stim(3).ypos_vec =  [nan(1, prestim_time*50)...
                    ...
                    nan(1, poststim_time*50)];
stim(3).type = 'flicker';
stim(3).time = length(stim(3).xpos_vec)/50;

%% flicker L 1/2 hz
stim(4).name    = 'flicker_Rside_0.5_hz';
stim(4).num     = 4;
stim(4).pat_id  = 2;
...
stim(4).ypos_vec = [nan(1, prestim_time*50)...
                    ...
                    nan(1, poststim_time*50)];
stim(4).type = 'flicker';
stim(4).time = length(stim(4).xpos_vec)/50;

%% flicker L 1 hz
stim(5).name    = 'flicker_Rside_1_hz';
stim(5).num     = 5;
stim(5).pat_id  = 2;
...
stim(5).ypos_vec = [nan(1, prestim_time*50)...
                    ...
                    nan(1, poststim_time*50)];
stim(5).type = 'motion';
stim(5).time = length(stim(5).xpos_vec)/50;

%% flicker L 3 hz
stim(6).name    = 'flicker_Rside_10_hz';
stim(6).num     = 6;
stim(6).pat_id  = 2;
...
stim(6).ypos_vec =  [nan(1, prestim_time*50)...
                    ...
                    nan(1, poststim_time*50)];
stim(6).type = 'motion';
stim(6).time = length(stim(6).xpos_vec)/50;

%% flicker R 1/2 hz
stim(7).name    = 'flicker_Lside_0.5_hz';
stim(7).num     = 7;
stim(7).pat_id  = 3;
...
stim(7).ypos_vec = [nan(1, prestim_time*50)...
                    ...
                    nan(1, poststim_time*50)];
stim(7).type = 'motion';
stim(7).time = length(stim(7).xpos_vec)/50;

%% flicker L 1 hz
stim(8).name    = 'flicker_Lside_1_hz';
stim(8).num     = 8;
stim(8).pat_id  = 3;
...
stim(8).ypos_vec = [nan(1, prestim_time*50)...
                    ...
                    nan(1, poststim_time*50)];
stim(8).type = 'motion';
stim(8).time = length(stim(8).xpos_vec)/50;

%% flicker L 3 hz
stim(9).name    = 'flicker_Lside_10_hz';
stim(9).num     = 9;
stim(9).pat_id  = 3;
...
stim(9).ypos_vec = [nan(1, prestim_time*50)...
                    ...
                    nan(1, poststim_time*50)];
stim(9).type = 'motion';
stim(9).time = length(stim(9).xpos_vec)/50;
