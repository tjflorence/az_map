...
%% horz off bar slow 
stim(43).name = 'smallbar_horz_off_30_dps';
stim(43).num = 43;
stim(43).pat_id = ????
...
%% horz off bar medium 
stim(44).name = 'smallbar_horz_off_30_dps';
stim(44).num = 34;
stim(44).pat_id = ????
...
%% horz off bar fast 
stim(45).name = 'smallbar_horz_off_30_dps';
stim(45).num = 45;
stim(45).pat_id = ????
...
%% horz on bar slow 
stim(46).name = 'smallbar_horz_on_30_dps';
stim(46).num = 46;
stim(46).pat_id = ????
...
%% horz on bar medium 
stim(47).name = 'smallbar_horz_on_30_dps';
stim(47).num = 47;
stim(47).pat_id = ????
...
%% horz on bar fast 
stim(48).name = 'smallbar_horz_on_30_dps';
stim(48).num = 48;
stim(48).pat_id = ????
