...
stim(88).name = 'motion_L_diag_fwd_L_0.5_hz';
stim(88).num = 88;
stim(88).pat_id = 25;
...
stim(89).name = 'motion_L_diag_fwd_L_1_hz';
stim(89).num = 89;
stim(89).pat_id = 25;
...
stim(90).name = 'motion_L_diag_fwd_L_3_hz';
stim(90).num = 90;
stim(90).pat_id = 25;
...
stim(91).name = 'motion_L_diag_fwd_R_0.5_hz';
stim(91).num = 91;
stim(91).pat_id = 25;
...
stim(92).name = 'motion_L_diag_fwd_R_1_hz';
stim(92).num = 92;
stim(92).pat_id = 25;
...
stim(93).name = 'motion_L_diag_fwd_R_3_hz';
stim(93).num = 93;
stim(93).pat_id = 25;
...
stim(94).name = 'motion_R_diag_fwd_L_0.5_hz';
stim(94).num = 94;
stim(94).pat_id = 27;
...
stim(95).name = 'motion_R_diag_fwd_L_1_hz';
stim(95).num = 95;
stim(95).pat_id = 27;
...
stim(96).name = 'motion_R_diag_fwd_L_3_hz';
stim(96).num = 96;
stim(96).pat_id = 27;
...
stim(97).name = 'motion_R_diag_fwd_R_0.5_hz';
stim(97).num = 97;
stim(97).pat_id = 27;
...
stim(98).name = 'motion_R_diag_fwd_R_1_hz';
stim(98).num = 98;
stim(98).pat_id = 27;
...
stim(99).name = 'motion_R_diag_fwd_R_3_hz';
stim(99).num = 99;
stim(99).pat_id = 27;
