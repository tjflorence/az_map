...
%% L diag back bar wf,  slow 
stim(43).name = 'motion_wf_diag_back_L_0.5_hz';
stim(43).num = 43;
stim(43).pat_id = ????
...
%% L diag back bar wf,  medium 
stim(44).name = 'motion_wf_diag_back_L_1_hz';
stim(44).num = 44;
stim(44).pat_id = ????
...
%% L diag back bar wf, fast 
stim(45).name = 'motion_wf_diag_back_L_3_hz';
stim(45).num = 44;
stim(45).pat_id = ????
...
%% R diag back bar wf, slow 
stim(43).name = 'motion_wf_diag_back_R_0.5_hz';
stim(43).num = 43;
stim(43).pat_id = ????
stim(43).xpos_vec = [nan(1, prestim_time*50)...
                        ones(1, 50*motion_stim_time)...                    
...
%% R diag back bar wf,  medium 
stim(44).name = 'motion_wf_diag_back_R_1_hz';
stim(44).num = 44;
stim(44).pat_id = ????
stim(44).xpos_vec = [nan(1, prestim_time*50)...
                        ones(1, 50*motion_stim_time)...                    
...
%% R diag back bar wf, fast 
stim(45).name = 'motion_wf_diag_back_R_3_hz';
stim(45).num = 44;
stim(45).pat_id = ????
stim(45).xpos_vec = [nan(1, prestim_time*50)...
                        ones(1, 50*motion_stim_time)...                    
...
%% L diag back bar L side, slow left motion
stim(43).name = 'motion_L_diag_back_L_0.5_hz';
stim(43).num = 43;
stim(43).pat_id = ????
stim(43).xpos_vec = [nan(1, prestim_time*50)...
                        ones(1, 50*motion_stim_time)...                    
...
stim(44).name = 'motion_L_diag_back_L_1_hz';
stim(44).num = 44;
stim(44).pat_id = ????
stim(44).xpos_vec = [nan(1, prestim_time*50)...
                        ones(1, 50*motion_stim_time)...                    
...
stim(45).name = 'motion_L_diag_back_L_3_hz';
stim(45).num = 44;
stim(45).pat_id = ????
stim(45).xpos_vec = [nan(1, prestim_time*50)...
                        ones(1, 50*motion_stim_time)...                    
...
stim(43).name = 'motion_L_diag_back_R_0.5_hz';
stim(43).num = 43;
stim(43).pat_id = ????
stim(43).xpos_vec = [nan(1, prestim_time*50)...
                        ones(1, 50*motion_stim_time)...                    
...
stim(44).name = 'motion_L_diag_back_R_1_hz';
stim(44).num = 44;
stim(44).pat_id = ????
stim(44).xpos_vec = [nan(1, prestim_time*50)...
                        ones(1, 50*motion_stim_time)...                    
...
stim(45).name = 'motion_L_diag_back_R_3_hz';
stim(45).num = 44;
stim(45).pat_id = ????
stim(45).xpos_vec = [nan(1, prestim_time*50)...
                        ones(1, 50*motion_stim_time)...                    
...
stim(43).name = 'motion_R_diag_back_L_0.5_hz';
stim(43).num = 43;
stim(43).pat_id = ????
stim(43).xpos_vec = [nan(1, prestim_time*50)...
                        ones(1, 50*motion_stim_time)...                    
...
stim(44).name = 'motion_R_diag_back_L_1_hz';
stim(44).num = 44;
stim(44).pat_id = ????
stim(44).xpos_vec = [nan(1, prestim_time*50)...
                        ones(1, 50*motion_stim_time)...                    
...
stim(45).name = 'motion_R_diag_back_L_3_hz';
stim(45).num = 44;
stim(45).pat_id = ????
stim(45).xpos_vec = [nan(1, prestim_time*50)...
                        ones(1, 50*motion_stim_time)...                    
...
stim(43).name = 'motion_R_diag_back_R_0.5_hz';
stim(43).num = 43;
stim(43).pat_id = ????
stim(43).xpos_vec = [nan(1, prestim_time*50)...
                        ones(1, 50*motion_stim_time)...                    
...
stim(44).name = 'motion_R_diag_back_R_1_hz';
stim(44).num = 44;
stim(44).pat_id = ????
stim(44).xpos_vec = [nan(1, prestim_time*50)...
                        ones(1, 50*motion_stim_time)...                    
...
stim(45).name = 'motion_R_diag_back_R_3_hz';
stim(45).num = 44;
stim(45).pat_id = ????
stim(45).xpos_vec = [nan(1, prestim_time*50)...
                        ones(1, 50*motion_stim_time)...                    
