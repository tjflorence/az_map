...
stim(100).name = 'motion_wf_diag_back_L_0.5_hz';
stim(100).num = 100;
stim(100).pat_id = 20;
...
stim(101).name = 'motion_wf_diag_back_L_1_hz';
stim(101).num = 101;
stim(101).pat_id = 20;
...
stim(102).name = 'motion_wf_diag_back_L_3_hz';
stim(102).num = 102;
stim(102).pat_id = 20;
...
stim(103).name = 'motion_wf_diag_back_R_0.5_hz';
stim(103).num = 103;
stim(103).pat_id = 20;
...
stim(104).name = 'motion_wf_diag_back_R_1_hz';
stim(104).num = 104;
stim(104).pat_id = 20;
...
stim(105).name = 'motion_wf_diag_back_R_3_hz';
stim(105).num = 105;
stim(105).pat_id = 20;
...
stim(106).name = 'motion_L_diag_back_L_0.5_hz';
stim(106).num = 106;
stim(106).pat_id = 24;
...
stim(107).name = 'motion_L_diag_back_L_1_hz';
stim(107).num = 107;
stim(107).pat_id = 24;
...
stim(108).name = 'motion_L_diag_back_L_3_hz';
stim(108).num = 108;
stim(108).pat_id = 24;
...
stim(109).name = 'motion_L_diag_back_R_0.5_hz';
stim(109).num = 109;
stim(109).pat_id = 26;
...
stim(110).name = 'motion_L_diag_back_R_1_hz';
stim(110).num = 110;
stim(110).pat_id = 26;
...
stim(111).name = 'motion_L_diag_back_R_3_hz';
stim(111).num = 111;
stim(111).pat_id = 26;
...
stim(112).name = 'motion_R_diag_back_L_0.5_hz';
stim(112).num = 112;
stim(112).pat_id = 26;
...
stim(113).name = 'motion_R_diag_back_L_1_hz';
stim(113).num = 113;
stim(113).pat_id = 26;
...
stim(114).name = 'motion_R_diag_back_L_3_hz';
stim(114).num = 114;
stim(114).pat_id = 26;
...
stim(115).name = 'motion_R_diag_back_R_0.5_hz';
stim(115).num = 115;
stim(115).pat_id = 26;
...
stim(116).name = 'motion_R_diag_back_R_1_hz';
stim(116).num = 116;
stim(116).pat_id = 26;
...
stim(117).name = 'motion_R_diag_back_R_3_hz';
stim(117).num = 117;
stim(117).pat_id = 26;
