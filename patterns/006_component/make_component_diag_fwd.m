...
sbd = [fliplr(diag) ones(size(bars)) ones(size(diag))];
...
directory_name = '/Users/florencet/Documents/matlab_root/az_map/patterns/006_component/patterns';
str = [pwd '/patterns/Pattern_03_component_diag_fwd'];
save(str, 'pattern');
